...
class kernel{
    ...
    public static enum opcodes {
		ADDU, SUBU, SLLV, SRAV, SRLV, AND, OR, NOR, SLT, SLTU, MOV, LW, LBU, SW, SB, JALR, ROL, ROR, XOR,
	...
	public static void initialization() throws IOException {
		...
		opcodeTable.put("ROL"  , "01110");
		// ROR: rotate to the right
		opcodeTable.put("ROR"  , "01111");
		// XOR: exclusive
		opcodeTable.put("XOR"  , "10100");
